        ...
        <div className="flex w-full">
          <div className="w-full prose sm:prose-lg md:w-3/5 md:pr-10">
            ...
            <p>
              ...
              that has helped me for so many years. I have gotten to where I am right now in my
              career thanks in no small part due to the selfless contributions of talented engineers
              within the open source community. If you happen to be one of them, know that you have
              my heartfelt thanks.
            </p>
            <p>
